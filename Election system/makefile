...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/SelectionPolicy.o bin/JoinPolicy.o bin/offersArray.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/SelectionPolicy.o bin/JoinPolicy.o bin/offersArray.o
...
bin/offersArray.o: src/offersArray.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/offersArray.o src/offersArray.cpp
